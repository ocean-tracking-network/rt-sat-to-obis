...
BEGIN
    ...
    -- Populate otn_satellite_tags_animals from a single remote join
    INSERT INTO obis.otn_satellite_tags_animals (
        ...
        datereleaseanimal,
        datedetectionsreleased,
        notes,
        organism_id,
        tag_datelastmodified,
        tag_institutioncode,
        tag_collectioncode,
        tag_catalognumber,
        ptt_code,
    ...
    SELECT
        ...
        t.ageunit,
        t.lifestage,
        t.lifestagedescription,
        t.datereleaseanimal,
        t.datedetectionsreleased,
        t.notes,
        t.organism_id,
        t.tag_datelastmodified,
        t.tag_institutioncode,
        t.tag_collectioncode,
        t.tag_catalognumber,
        t.ptt_code,
        t.tag_startdatetime::timestamp,
        t.tag_enddatetime::timestamp,
        t.tag_timezone,
        t.tag_locality,
        t.tag_latitude,
        t.tag_longitude,
    ...
    FROM dblink(
        ...
        'SELECT
            ...
            oa.ageunit,
            oa.lifestage,
            oa.lifestagedescription,
            oa.datereleaseanimal,
            oa.datedetectionsreleased,
            oa.notes,
            oa.organism_id,
            ot.datelastmodified,
            ot.institutioncode,
        ...
        tag_catalognumber varchar,
        ptt_code varchar,
        tag_startdatetime text,
        tag_enddatetime text,
        tag_timezone varchar,
        tag_locality varchar,
        tag_latitude numeric,
        tag_longitude numeric,
